...
const StockNews = () => {
  ...
  useEffect(() => {
    ...
    script.innerHTML = JSON.stringify({
        ...
        width: "100%",
        height: "100%",
        defaultColumn:"overview","market":"stock","screener_type":"stock_mkt","displayCurrency":"USD",
    });
  ...
  return (
    <div className="tradingview-widget-container">
      ...
      <div className="tradingview-widget-copyright">
        <a href="https://www.tradingview.com/" rel="noopener nofollow" target="_blank"><span>Daily stock news</span> By TradingView</a>
      </div>
    </div>
  );
};
