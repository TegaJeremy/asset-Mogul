...
const ForexNews = () => {
  ...
  useEffect(() => {
    ...
    script.innerHTML = JSON.stringify({
        ...
        width: "100%",
        height: "100%",
        defaultColumn:"overview","market":"forex","screener_type":"forex_mkt","displayCurrency":"USD",
    });
  ...
  return (
    <div className="tradingview-widget-container">
      ...
      <div className="tradingview-widget-copyright">
        <a href="https://www.tradingview.com/" rel="noopener nofollow" target="_blank"><span>Daily currency news</span> By TradingView</a>
      </div>
    </div>
  );
};
