...
const PendingWithdrawal = () => {
    ...
    const getAllpendingWithdrawals = async ()=>{
        try{
            const response = await axios.get("https://assets-mogilbackend.onrender.com/getWithdrawalRequests")
    ...
    const acceptWithdrawal = async (id)=>{
        const url = "https://assets-mogilbackend.onrender.com/acceptWithdrawal"
    ...
    const rejectWithdrawal = async (id)=>{
        const url = "https://assets-mogilbackend.onrender.com/rejectWithdrawal"
        const body = {userId: id}
        try{
