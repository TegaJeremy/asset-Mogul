...
const GeneralNumbers = () => {
    ...
    const getAllUsers = ()=>{
        ...
        fetch('https://assets-mogilbackend.onrender.com/getAllUsersCount', { method: 'GET' })
    ...
    const getKycCount = ()=>{
        ...
        fetch('https://assets-mogilbackend.onrender.com/unverifiedCount', { method: 'GET' })
            .then(response => response.json())
    ...
    const getTotalDeposit = ()=>{
        ...
        fetch('https://assets-mogilbackend.onrender.com/getTotalDepositsForAllUsr', { method: 'GET' })
            .then(response => response.json())
