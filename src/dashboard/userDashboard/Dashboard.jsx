...
const Dashboard = () => {
  ...
  async function getTotalDeposit() {
    try {
      const response = await axios.get(
        `https://assets-mogilbackend.onrender.com/getTotalDeposit/${id}`
      );
  ...
  async function getPendingDeposit() {
    try {
      const response = await axios.get(
        `https://assets-mogilbackend.onrender.com/getPendingDeposit/${id}`
      );
      console.log(response);
  ...
  async function getLastDeposit() {
    try {
      const response = await axios.get(
        `https://assets-mogilbackend.onrender.com/getLastDeposit/${id}`
      );
      console.log(response);
  ...
  async function getTotalWithdrawal() {
    try {
      const response = await axios.get(
        `https://assets-mogilbackend.onrender.com/getTotalWithdraw/${id}`
      );
      console.log(response);
  ...
  async function getPendingwithdrawl() {
    try {
      const response = await axios.get(
        `https://assets-mogilbackend.onrender.com/getPendingwithdrawl/${id}`
      );
      console.log(response);
  ...
  async function RejectedWithdral() {
    try {
      const response = await axios.get(
        `https://assets-mogilbackend.onrender.com/RejectedWithdral/${id}`
      );
      console.log(response);
  ...
  async function getLastWithdrawal() {
    try {
      const response = await axios.get(
        `https://assets-mogilbackend.onrender.com/getLastWithdrawal/${id}`
      );
      console.log(response);
  ...
  async function getIntersetWallet() {
    try {
      const response = await axios.get(
        `https://assets-mogilbackend.onrender.com/getUserIntrestWallet/${id}`
      );
      console.log(response);
  ...
  async function getLastInvestment() {
    try {
      const response = await axios.get(
        `https://assets-mogilbackend.onrender.com/getLastInvestment/${id}`
      );
      console.log(response);
  ...
  async function getRunningInvestment() {
    try {
      const response = await axios.get(
        `https://assets-mogilbackend.onrender.com/getRunningInvestment/${id}`
      );
      console.log(response);
  ...
  async function getCompletedInvestment() {
    try {
      const response = await axios.get(
        `https://assets-mogilbackend.onrender.com/getCompletedInvestment/${id}`
      );
      console.log(response);
  ...
  async function getLatestTransaction() {
    try {
      const response = await axios.get(
        `https://assets-mogilbackend.onrender.com/getLatestTransaction/${id}`
      );
      console.log(response);
