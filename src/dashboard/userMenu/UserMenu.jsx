...
const UserMenu = () => {
  ...
  async function getAccountBalanceDetails() {
    try {
      const response = await axios.get(
        `https://assets-mogilbackend.onrender.com/getUserTotalBalance/${id}`
      );
  ...
  async function getDepositWallet() {
    try {
      const response = await axios.get(
        `https://assets-mogilbackend.onrender.com/getUserDepositWallet/${id}`
      );
  ...
  async function getReferalWallet() {
    try {
      const response = await axios.get(
        `https://assets-mogilbackend.onrender.com/getUserReferalWallet/${id}`
      );
      console.log(response);
  ...
  async function LogoutUser() {
    ...
    try {
      const response = await axios.post(
        `https://assets-mogilbackend.onrender.com/logout/${id}`,
        null,
        {
          headers: {
