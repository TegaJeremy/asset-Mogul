        ...
        <div className="SignUpCard">
          {nextPhase && !inputError ? (
            ...
            <section className="SignUpInput_Wrapper">
              ...
              {/* <div> */}
              <div className="SignUp_InputsParts">
                {/* <div className="SignUp_Inputs_User_Email">
                  <p>Select Username or Email below for registration</p>
                  <article>
                    <span
                      onClick={() => {
                        setRgistrationType("username");
                      }}
                      style={{
                        background:
                    ...
                    <span
                      onClick={() => {
                        setRgistrationType("email");
                      }}
                      style={{
                        background:
                          registrationType === "email" || errorType === "email"
                            ? "green"
                            : null,
                      }}>
                      Email
                  ...
                  <input
                    ...
                    type="text"
                    placeholder={
                      registrationType === "username" ? "Username" : "Email"
                    }
                  />
                </div> */}
                <div className="SignUp_Inputs">
                  ...
                  <input
                    ...
                    style={{
                      border: errorType === "username" ? "1px solid red" : null,
                    }}
                ...
                <div className="SignUp_Inputs">
                  ...
                  <select
                    ...
                    style={{
                      border: errorType === "country" ? "1px solid red" : null,
                    }}
                    type="text"
                    onChange={(e) => {
                ...
                <div className="SignUp_Inputs">
                  ...
                  <input
                    ...
                    style={{
                      border: errorType === "password" ? "1px solid red" : null,
                    }}
                    // style={{
                    //   border: errorType === "password" ? "1px solid red" : null,
                    // }}
